      ...
      <div className="bot-options-container">
        {openDropdown === 'Simple Bots' && (
          <div className="bot-options">
            {botOptions['Simple Bots'].map((bot, index) => (
              <button key={index} className="bot-option" onClick={() => handleOptionClick(bot.label)}>
                {bot.icon} {bot.label}
              </button>
            ))}
          </div>
        ...
        {openDropdown === 'Custom Applications' && (
          <div className="bot-options">
            {botOptions['Custom Applications'].map((bot, index) => (
              <button key={index} className="bot-option" onClick={() => handleOptionClick(bot.label)}>
                {bot.icon} {bot.label}
              </button>
            ))}
