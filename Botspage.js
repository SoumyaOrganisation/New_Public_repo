        ...
        {isModalOpen && (
          <div className="popup">
            <div className="popup-header">
              <h3>{selectedFile ? selectedFile.name : popupContent.title}</h3>
              ...
              {!selectedFile ? (
                <ul>
                  {popupContent.files.map((file) => (
                    <li key={file.index} onClick={() => handleFileClick(file)}>
                      {file.name}
                    </li>
                  ))}
                </ul>
                  ...
                  {selectedFile.imageUrl ? (
                    <div>
                      ...
                      <button
                        ...
                        onClick={() => handleDownloadAsZip(selectedFile.downloadUrl, selectedFile.name, selectedFile.imageUrl)}
                      >
                        Download Script
                      </button>
                    </div>
