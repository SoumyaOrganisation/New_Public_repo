...
import monitoring1 from "../images/Observability.png";
import asset1 from "../images/AssetManagement.png";
import cloud1 from "../images/PublicCloudOps.png";
import soc1 from "../images/CloudSecurity.png";
import finops1 from "../images/FinOps.png";
import reporting1 from "../images/Dashboard.png";
import itsm1 from "../images/ServiceManagement.png";
import noc1 from "../images/Datacenter&NOC.png";
import automation1 from "../images/AutomationBotI.png";
import bot from "../images/AutomationBotII.png";
...
const services = [
  ...
  },
  {
    ...
    backgroundColor: 'rgb(177 144 12)', // Yellow
    tintColor: '#ffffff',
    allowedDepartments: ['Delivery', 'Service Delivery', 'Emerging Technologies']
  },
  {
  ...
  },
  {
    ...
    icon: bot,
    link: '/botpage',
    backgroundColor: '#e67e22', // Carrot (Bright Orange)
    tintColor: '#ffffff',
    allowedDepartments: ['Delivery', 'Service Delivery', 'Emerging Technologies']
  },
  {
  ...
  },
  {
    ...
    icon: reporting1,
    link: '/dashboard',
    backgroundColor: 'rgb(7 87 165)', // Medium dark grey
    tintColor: '#ffffff',
...
const HomePage = () => {
  ...
  const [_currentQueryType, setCurrentQueryType] = useState('');
          ...
          {filteredServices.length > 0 ? (
            filteredServices.map((service, index) => (
              <button
                ...
                // role="button"
                aria-label={`Select ${service.title} service`} // Corrected to match the service title
                tabIndex={0}
              >
                {/* Add a dynamic style or class for tint */}
                <img
                  src={service.icon}
                  alt={service.title}
                  className={`service-icon ${service.tintColor ? 'tinted' : ''}`}
                  style={{
                    filter: service.tintColor
